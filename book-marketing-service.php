	...
	<?php include "./components/header.php"?>
		<section class="main-banner-custom bg-service-paper">
			<div class="container">
				...
				<div class="col-lg-10 col-md-10">
					<span class="subheading-clr">BOOK MARKETING SERVICE</span>
						<h1> <span> Navigate the literary landscape and gain authorial impact </span></h1>
						<p> We help you drive discoverability and sales with our book marketing expertise and page-turning promotions. </p> <img src="assets/images/banner-logo.png" alt="">
					...
					<div class="col-xl-6">
						<div class="welcome-one__left">
							<div class="inner-section"> <span class="section-title__tagline">Let us publish your Paper</span>
								<h2 class="inner-pages-title">Double-up your book's visibility with our proven marketing strategies.</h2> </div>
					...
					<div class="col-xl-6">
						<div class="welcome-one__right clearfix">
							...
							<div class="wow slideInRight animated" data-wow-delay="100ms" data-wow-duration="2500ms" style="visibility: visible; animation-duration: 2500ms; animation-delay: 100ms; animation-name: slideInRight;">
								<div class="inner-pages-img"> <img src="assets/images/inner/book-marketing.webp" alt=""> </div>
							</div>
						</div>
					</div>
		...
		<section class="features-two bg-paper-pub">
			<div class="inner-section text-center"> <span class="section-title__tagline">We Have Experts For All</span>
				<h2 class="inner-pages-title-white">Our book marketing approach: crafting success stories</h2> </div>
			<div class="container">
				<div class="row justify-content-center ">
					...
					<div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
						<div class="features-one__single">
							...
							<div class="features-one__single-text">
								...
								<p> We delve deep into the core of your book, exploring its themes, understanding your target audience, and identifying unique selling points. This thorough analysis lays the groundwork for a customized marketing approach that aligns seamlessly with your goals and overall vision. </p>
								<br>
								<br> </div>
						</div>
					</div>
					...
					<div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
						<div class="features-one__single">
							...
							<div class="features-one__single-text">
								...
								<p> Our expertise extends beyond the pages of your book; it reaches the influencers, bloggers, and literary communities that shape the literary landscape. Through targeted outreach, we leverage industry insights to ensure your book receives the attention it deserves. </p>
								<br>
								<br> </div>
						</div>
					</div>
					...
					<div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
						<div class="features-one__single">
							...
							<div class="features-one__single-text">
								...
								<p> Our dedicated team specializes in crafting compelling and shareable content that not only sparks interest but ignites conversations around your book. From captivating social media posts to attention-grabbing press releases, every piece of content is tailored to resonate with your target audience. </p>
							</div>
						</div>
					</div>
					<!--End Single Features One-->
					...
					<div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
						<div class="features-one__single">
							...
							<div class="features-one__single-text">
								...
								<p> We focus on enhancing your authorial identity, building a brand that not only aligns seamlessly with your book but also establishes a lasting connection with your readers. Our author branding strategies create an identity that resonates with authenticity and leaves a lasting impression.</p>
								<br>
								<br> </div>
						</div>
					</div>
					...
					<div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
						<div class="features-one__single">
							<div class="features-one__single-icon"> <span class="icon-recruitment"></span> </div>
							<div class="features-one__single-text">
								<h4><a href="#!">Leverage social media</a></h4>
								<p> We utilize popular social media platforms to connect with readers. We develop a social media presence by sharing engaging content, book teasers, author interviews, and relevant industry insights. Building a social media presence helps create a community around the author and their works.</p>
								<br> </div>
						</div>
					</div>
					<!--End Single Features One-->
					...
					<div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
						<div class="features-one__single">
							<div class="features-one__single-icon"> <span class="icon-recruitment"></span> </div>
							<div class="features-one__single-text">
								<h4><a href="#1">Data analytics and adaptation</a></h4>
								<p> We implement data analytics tools to measure the effectiveness of our marketing efforts and keep a track of sales, website traffic, and social media engagement. Our strategies are based on acquired insights to continually optimize the marketing approach and author’s reach.</p>
							</div>
						</div>
					</div>
					<!--End Single Features One-->
