			...
			<div class="row">
				...
				<div class="col-xl-4 col-lg-4 col-md-4 wow animated fadeInUp" data-wow-delay="0.1s">
					<div class="footer-widget__column footer-widget__about">
						<div class="footer-widget__about-logo">
							<a href="/"><img class="footer-logo" src="assets/images/logo-white-v2.png" alt=""></a>
				...
				<div class="col-xl-2 col-lg-2 col-md-2 wow animated fadeInUp" data-wow-delay="0.7s">
					<div class="footer-widget__column footer-widget__contact">
						...
						<p class="phone"><a href="tel:+123456">+123456</a></p>. <img src="assets/images/US-Payments-2.png" alt=""> </div>
				</div>
				<!--End Footer Widget Column-->
			</div>
		</div>
...
</a></div> --><a href="#" data-target="html" class="scroll-to-target scroll-to-top"><i class="fa fa-angle-up"></i></a>
