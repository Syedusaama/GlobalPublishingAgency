    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-7 col-md-7">
                ...
                <h1> <span> Crafting bestsellers, one book at a time </span></h1>
                <p> Explore our comprehensive book publishing solutions.</p>
...
<section class="features-two bg-paper-pub">
    <div class="inner-section text-center">
        ...
        <h2 class="inner-pages-title-white">Developing market-ready masterpieces</h2>
    </div>
    <div class="container">
        <div class="row justify-content-center ">
            ...
            <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                <div class="features-one__single">
                    ...
                    <div class="features-one__single-text">
                        ...
                        <p>
                            In this pivotal stage, our skilled team conducts a thorough examination of your manuscript, meticulously identifying areas for enhancement. We delve into the core of your work, offering valuable insights to elevate its overall quality and impact.</p>
                            <br><br>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                <div class="features-one__single">
                    ...
                    <div class="features-one__single-text">
                        <h4><a href="#!">Cover Design and Formatting</a></h4>
                        <p>
                            Our team is dedicated to creating a captivating first impression with a visually striking book cover. We ensure your manuscript is formatted for both print and digital formats, adhering to industry standards for a seamless and aesthetically pleasing reading experience.</p>
                    </div>
                </div>
            </div>
            <!--End Single Features One-->
            ...
            <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div class="features-one__single">
                    ...
                    <div class="features-one__single-text">
                        <h4><a href="#!">Printing and Production</a></h4>
                        <p>
                            With your manuscript refined and designed, we move on to the production phase. We offer a range of publishing formats, including paperback, hardcover, and e-book, allowing you to tailor the presentation of your work to your preferences.</p>
                        <br><br>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                <div class="features-one__single">
                    ...
                    <div class="features-one__single-text">
                        <h4><a href="#!">Distribution Strategy</a></h4>
                        <p>
                            A crucial aspect of successful publishing involves getting your book into the hands of readers. Our tailored plans aligned with your goals and target audience help optimize the reach and impact of your book, including online retailers, bookstores, and e-book platforms.</p> <br>
                    </div>
                </div>
            </div>
            <!--End Single Features One-->
