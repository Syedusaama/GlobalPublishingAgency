                                ...
                                <div class="left">
                                    <ul class="main-menu__list">
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul>
                                                <li><a href="ebook-publication.html">e-Book Publication</a></li>
                                                <li><a href="paper-publication.html">Paper Publication</a></li>
    ...
    <div class="container">
        <div class="row content-area-com">
            ...
            <p> notice discloses the privacy practices for globalpublishingcenter.com. This privacy notice applies solely to information collected by this website. It will notify you of the following: What personally identifiable information is collected from you through the website, how it is used, and with whom it may be shared.
                ...
                <br>
                Unless you ask us not to, we may contact you via email or phone to tell you about specials, new products or services, or changes to this privacy policy.
            </p>

            <h5>SECURITY</h5>
            <p> We protect your information offline. Only employees and contractors who need the information to perform a specific job (for example, billing or the services ordered) are granted access to personally identifiable information. The computers/servers in which we store personally identifiable information are kept in a secure environment.
                <br>
                We at Global Publishing Center value our customers’ privacy and we are highly committed to keeping client's personal information safe and secure. We collect only essential and inevitable information to process your order. We never share any of your information with any individual or company in any way until you agree to permit us for doing so.
                <br>
                All information is collected through Global Publishing Center uses highly secured platforms to ensure there is no breach of data.
            </p>
            ...
            <h5>IP ADDRESS AND COOKIES</h5>
            <p> information such as your IP address is automatically recorded when you enter our website. This information is used only to diagnose server problems and site administration. Cookies are used on this site to enhance user experience and for collecting usage statistics.</p>

            <h5>INFORMATION ABOUT OUR PRODUCTS AND SERVICES</h5>
            <p>We make every effort to be as accurate as possible in describing the services and products offered on globalpublishingcenter.com. We do not warrant that the product or service descriptions, or any other content on this site, is accurate, complete, reliable, current, or free of error. Please call or email us immediately if you feel that the product or service you received from us differs from the descriptions on this website. 

            If you feel that we are not abiding by this privacy policy, you should contact us immediately via telephone at +1-12345679 or contact us via email at support@globalpublishingcenter.com.</p>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 wow animated fadeInUp" data-wow-delay="0.1s">
                    <div class="footer-widget__column footer-widget__about">
                        <div class="footer-widget__about-logo">
                            <a href="index-2.html"><img src="assets/images/logo-white-v2.png" alt=""></a> <br> <br>
                            At Global Publishing Agency, we're eager to hear from you and explore how we can bring your literary vision to life. Whether you're ready to embark on a ghostwriting journey, have questions about our services, or want to discuss the details of your project, our team is here to assist you.
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 wow animated fadeInUp" data-wow-delay="0.7s">
                    <div class="footer-widget__column footer-widget__contact">
                        ...
                        <!--</p>-->
                        <p><a href="mailto:info@globalpublishingcenter.com">info@globalpublishingcenter.com</a></p>
                        <p class="phone"><a href="tel:+1 (202) 773-6149">+1 (202) 773-6149</a></p>.
                ...
                <div class="col-xl-12">
                    <div class="footer-one__bottom-inner">
                        <div class="footer-one__bottom-text text-center">
                            <p>&copy; Copyright 2023 by Golbalpublishers</p>
                        </div>
                    </div>
                </div>
            </div>
