...
<section class="main-banner-custom bg-reviews">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
                <div class="page-header__wrapper">
                    <div class="col-lg-7 col-md-7  page-header__title">

                        <h2> <span> Stories of Collaboration  </span></h2>
                        <p> Real authors, real testimonials, real literary success.</p>
...
<div class="fluid">
    <div class="row">
        <div class="review-body">
            ...
            <p class="review-text">Working with Global Publishing Agency was a game-changer for me. Their team of ghostwriters not only captured the essence of my ideas but elevated them to a level I hadn't imagined. The collaborative process was seamless. Thanks to Global Publishing Agency, I am now a bestselling author with a book that truly reflects my voice.</p>
            <p class="review-name">- Elizabeth Jones</p>
        ...
        <div class="col-lg-4 col-sm-12 review-sec-page">
            ...
            <p class="review-text">Choosing Global Publishing Agency for my debut novel was the best decision I made. The ghostwriting team listened to my vision, understood my characters, and brought them to life in ways I couldn't have envisioned. The support and expertise throughout the process were invaluable, and I owe it all to the exceptional ghostwriting services provided by their team.</p>
            <p class="review-name">- Elizabeth Jones</p>
            <!-- Review #2 -->
        </div>
        <div class="col-lg-4 col-sm-12 review-sec-page">
            ...
            <h3 class="review-title">High-Quality Editing Services</h3>
            <p class="review-text">The entire process was seamless, and the final manuscript exceeded my expectations. The publishing journey that followed was equally impressive, with their team guiding me through every step. My book is now a reality, and I couldn't be happier with the outcome!</p>
            <p class="review-name">- Michael Brown</p>
            <!-- Review #3 -->
        </div>
        <div class="col-lg-4 col-sm-12 review-sec-page">
            <img src="assets/images/testimonial/testimonials-v1-client-info-img2.webp" alt="">

            <h3 class="review-title">Professional and Efficient</h3>
            <p class="review-text">As a first-time author, the ghostwriting and publishing experience with Global Publishing Agency was a revelation. The writing team delicately handled my vision, turning it into a compelling narrative. The publishing process was a breeze, with their meticulous attention to detail ensuring a polished final product.</p>
            <p class="review-name">- Samantha Lee</p>
            <!-- Review #4 -->
        </div>
        <div class="col-lg-4 col-sm-12 review-sec-page">
            <img src="assets/images/testimonial/testimonials-v1-client-info-img2.webp" alt="">
        ...
        <div class="col-lg-4 col-sm-12 review-sec-page">
            ...
            <p class="review-text">Creating my author's website with Global Publishing Agency was a wonderful experience. They effortlessly captured the essence of my brand and translated it into a visually stunning and user-friendly website. The team's attention to detail, creativity, and commitment to reflecting my authorial identity made the process efficient. My website has become a central hub for my readers, and I couldn't be happier with the result.</p>
            <p class="review-name">- Michelle Kim</p>
            <!-- Review #6 -->
        </div>
        ...
        <div class=" col-lg-4 col-sm-12 review-sec-page">
            <img src="assets/images/testimonial/testimonials-v1-client-info-img2.webp" alt="">
            <h3 class="review-title">Excellent Publication Services</h3>
            <p class="review-text">Navigating the world of personal branding as an author can be overwhelming. Global Publishing Agency simplified the process, and their expertise in balancing aesthetics with functionality ensured that my website looks impressive and serves as an effective platform for engaging with my audience. I highly recommend Global Publishing Agency for their services.</p>
            <p class="review-name">- John Williams</p>
        </div>
        <!-- Review 8 -->
        <div class=" col-lg-4 col-sm-12 review-sec-page">
            <img src="assets/images/testimonial/testimonials-v1-client-info-img2.webp" alt="">
...
<!-- <div class="floating_btn">
    <a target="_blank" href="https://wa.me/+12027736149/?text=Hello,%20I%20need%20help%20in%20my%20publications">
      <div class="contact_icon">
